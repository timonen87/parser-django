...
urlpatterns = [
    ...
    path('group/', views.GroupView.as_view({'get': 'list', 'post': 'create'})),
    path('group/<int:pk>/', views.GroupView.as_view({'put': 'update', 'delete': 'destroy'})),
    
    path('analog_link/', views.AnalogLinkView.as_view({'get': 'list', 'post': 'create'})),
    path('analog_link/<int:pk>/', views.AnalogLinkView.as_view({'put': 'update', 'delete': 'destroy'})),
